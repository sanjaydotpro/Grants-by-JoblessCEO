...
function ComponentSeparator({ 
  ...
  return (
    <div 
      className={cn("w-full py-20 flex items-center justify-center space-x-4", className)}
      {...props}
    >
      {/* Left line */}
      ...
      <div className="relative w-12 h-12 rounded-full border-2 border-primary/20 bg-background flex items-center justify-center shadow-lg">
        {/* Inner circles */}
