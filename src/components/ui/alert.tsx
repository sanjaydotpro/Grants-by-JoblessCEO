  ...
  "relative w-full rounded-lg border border-slate-200 p-4 [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-slate-950 dark:border-slate-800 dark:[&>svg]:text-slate-50",
  {
    variants: {
      variant: {
        ...
        info: "border-amber-600/50 text-amber-600 dark:border-amber-600 [&>svg]:text-amber-600 dark:border-orange-400/50 dark:text-orange-400 dark:dark:border-orange-400 dark:[&>svg]:text-orange-400",
      },
    },
    defaultVariants: {
      variant: "default",
